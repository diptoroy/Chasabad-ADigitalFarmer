...
import com.ddev.chasabad_adigitalfarmer.util.Constants.Companion.CHANNEL_ID
import com.ddev.chasabad_adigitalfarmer.util.Constants.Companion.NOTIFICATION_CHANNEL_ID
...
class FireBaseNotificationService: FirebaseMessagingService() {
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setSmallIcon(R.drawable.farming)
            .setAutoCancel(true)
